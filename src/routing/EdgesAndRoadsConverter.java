...
//			throw new InvalidResultException;
	...
	public static Road[] checkStartAndTargetOfDijkstra(KrakEdge[] routeEdges, PathPreface pathPrefaceFrom, PathPreface pathPrefaceTo) {
		/**
		 * 
		 * Hvis Den f�rste Edge i ruten er lig PreFace.edge 1 eller 2 skal den f�rste Edge tilpasses mht. husnummer
		 * ellers skal PreFace.edge 1 eller 2 l�gges til og tilpasset med husnummer
		 * 
		 */
