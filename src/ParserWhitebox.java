...
public class ParserWhitebox {
	...
	@Test
	public void RoadNameTest1() {
		
		String[] result = {"","","","",""};
		AddressParser.findRoadName("123, 123", result);
		assertEquals("",result[0]);
	}
	
	@Test
	public void RoadNameTest2() {
		
		String[] result = {"","","","",""};
		AddressParser.findRoadName("Langvej 5a, 5. sal, 2300 Kbh S", result);
	...
	public void CityNameTest1() {
		...
		String[] result = {"","","","",""};
		AddressParser.findCityName("123, 123", result);
