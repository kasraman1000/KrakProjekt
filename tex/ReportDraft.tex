...
When a user of the application wants to see a part of the map, a request is send to the java server. The Controller class gets information to complete the request from different components of the program. When the region and route information has been generated it is send as a String to the client.\\
