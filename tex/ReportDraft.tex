...
\begin{document}
 ...
 To get an understanding of the requirements stated in the previous section, we will walk through these, and try to         analyze what is needed to meet them, and what the different solutions could be. But first, we will list our own points of focus and use these as arguments for one or another solution.\\
