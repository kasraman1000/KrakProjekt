...
\begin{document}
	...
	\section{Background and Data}
		...
		In other words, a user should be able to see a map of Denmark with a selective amount of major roads, then explore
		 this map by zooming in and out, and /*måske skulle man droppe otherwise, da der ikke er tale om et "enten eller"*/otherwise navigating around. A user should also be able to select two adresses,
